...
if($produto == "HEA" or $produto == "SRAC" or $produto == "MWO"){
	if($produto == "SRAC" or $produto == "MWO"){
		...
		$array_items = $reparoObj->readItemsTotalbyNP();
		...
		$array_items_anterior = $reparoObj->readItemsTotalbyNP();
		...
		$array_items = array_merge($array_items,$reparoObj->readItemsTotalbyNP());
		$totalvendaatual += $vendasObj->readbyNP();
		...
		$reparoObj->nomeproduto = "MWO";
		$vendasObj->nomeproduto = "MWO";
		$array_items_anterior = array_merge($array_items_anterior,$reparoObj->readItemsTotalbyNP());
		$totalvendaanterior += $vendasObj->readbyNP();
	...
	$array_items = $reparoObj->readItemsTotalbyLP();
	...
	$vendasObj->datavenda1 = $data1;
	$vendasObj->datavenda2 = $data2;
	$array_items_anterior = $reparoObj->readItemsTotalbyCH();
	$totalvendaanterior = $vendasObj->readbyNP();
	
}elseif($produto == "23" or $produto == "30" ){
	$reparoObj->litro = $produto;
	$vendasObj->nomeproduto = "MWO";
	$array_items = $reparoObj->readItemsTotalbyLI();
	$totalvendaatual = $vendasObj->readbyNP();
	$ano = $ano2;
	$ano2 = $ano2 - 1;
	$data1 = $ano2."-".$mes2."-1";
	...
	$vendasObj->datavenda1 = $data1;
	$vendasObj->datavenda2 = $data2;
	$array_items_anterior = $reparoObj->readItemsTotalbyLI();
	$totalvendaanterior = $vendasObj->readbyNP();
}	
